...
{currentStep === 'calendar' && (
  <div className="w-full flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-center">
    {/* Calendar */}
    <div className="w-full max-w-md mx-auto lg:mx-0 lg:w-auto">
      <Card className="bg-black/50 backdrop-blur-md border-purple-500/30 h-full">
        ...
        <CardContent className="flex justify-center">
          <Calendar
            ...
            className="rounded-md border border-purple-500/30 bg-black/30 text-white"
          />
        </CardContent>
      </Card>
    </div>
